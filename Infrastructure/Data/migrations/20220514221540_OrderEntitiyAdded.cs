...
{
    public partial class OrderEntitiyAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemOrdred_ProductItemId = table.Column<int>(type: "INTEGER", nullable: true),
                    ItemOrdred_ProductName = table.Column<string>(type: "TEXT", nullable: true),
                    ItemOrdred_PictureUrl = table.Column<string>(type: "TEXT", nullable: true),
                    Price = table.Column<double>(type: "decimal(18,2)", nullable: false),
